...
- [ ] 3.1 Implement title normalization (case-fold, strip punctuation, strip known noise suffixes like trailing " - Movies") and verify with a unit test covering the "Midnight Ferry: Part Two" suffix case
